// Launch graphic for the first X post. Image-led, minimal text, maximum attitude.
const fs = require("fs");
...
const pepe = "data:image/png;base64," + fs.readFileSync("assets/gallery/10.png").toString("base64");
...
<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900" viewBox="0 0 1600 900">
  ...
  <!-- kicker -->
  <text x="92" y="130" font-family="Space Mono" font-weight="700" font-size="28" letter-spacing="4" fill="${ACID}">// WHITELIST OPEN · MINT: MAYBE</text>

  <!-- headline -->
  <text x="86" y="350" font-family="Anton" font-size="168" fill="${PAPER}">WE ARE GOING</text>
  <text x="86" y="510" font-family="Anton" font-size="168" fill="${RED}">TO RUG YOU.</text>

  <text x="92" y="600" font-family="Space Mono" font-weight="700" font-size="30" fill="${SOFT}">you are the exit liquidity. we just said it first.</text>

  <!-- CTA pill -->
  <rect x="90" y="660" width="600" height="96" rx="8" fill="${ACID}"/>
  <text x="118" y="724" font-family="Anton" font-size="58" fill="${INK}">ENGMI.FUN/APPLY</text>
  <text x="612" y="722" font-family="Anton" font-size="58" fill="${INK}">→</text>
...
fs.writeFileSync("assets/x-launch.png", r.render().asPng());
console.log("wrote assets/x-launch.png");
